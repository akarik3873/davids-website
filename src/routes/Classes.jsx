    ...
    <div className={styles.page}>
      ...
      <section className={`${styles.section} ${styles.sectionAlt}`}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px', maxWidth: '1200px', margin: '0 auto', fontSize: '0.9rem' }}>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1', '@media (max-width: 640px)': { fontSize: '0.85rem' } }}>Sun 7/12</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Mon 7/13</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Tue 7/14</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Wed 7/15</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Thu 7/16</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Fri 7/17</div>
          <div style={{ textAlign: 'center', fontWeight: 'bold', padding: '12px', backgroundColor: '#f0f0f0', borderRadius: '4px', fontSize: '0.95rem', gridColumn: 'span 1' }}>Sat 7/18</div>
